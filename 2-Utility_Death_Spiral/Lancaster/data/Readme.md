...
(2) Hourly Solar Output.xlsx gives the solar output of a solar PV installation in the Boston area in watts on an hourly basis for a representative year. 
There are five tabs, for 2kW, 4kW, 6kW, 25 and 75 installations and there are 4 orientations (South, SouthWest, West, SouthEast)
