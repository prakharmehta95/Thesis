...
>>  (1) defining_classes.py to define prosumer and RunData classes, 
>>  (2) solar_pv_init.py to create the prosumer and buildingData pickles, and 
>>  (3) solar_pv.py is to run the model."
