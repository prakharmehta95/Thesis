...
> - defining_classes.py to define prosumer and RunData classes, 
> - solar_pv_init.py to create the prosumer and buildingData pickles, and 
> - solar_pv.py is to run the model."
