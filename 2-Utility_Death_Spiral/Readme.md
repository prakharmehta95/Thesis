...
- Type the city you want to run the model for (Cambridge or Lancaster). The main file calls the corresponding city folder. Each folder contains 3 Pytnon files: 
>>  (1) defining_classes.py to define prosumer and RunData classes, >> - (2) solar_pv_init.py to create the prosumer and buildingData pickles, and - (3) solar_pv.py is to run the model."
