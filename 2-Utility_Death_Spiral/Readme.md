...
- Open either of the main files ("Main_Dynamic.py" or "Main_Static.py". 
- Type the city you want to run the model for (Cambridge or Lancaster). The main file calls the corresponding folder  Cambridge or Lancaster. Each folder contains 3 Pytnon files: (1) defining_classes.py to define prosumer and RunData classes, (2) solar_pv_init.py to create the prosumer and buildingData pickles, and (3) solar_pv.py is to run the model."
- Calibrate the parameters located at the very begining of the code
- Click Run 
